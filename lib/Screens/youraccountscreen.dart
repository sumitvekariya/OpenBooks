                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          if (sp.username?.isNotEmpty ?? false)
                            GestureDetector(
                              onTap: () async {
                                try {
                                  if (!await launchUrl(Uri.parse("https://twitter.com/${sp.username}" ?? ""))) {
                                    throw Exception('Could not launch of twitter ${sp.username}');
                                  }
                                } catch (e) {
                          ...
                          SizedBox(width: 10.w),
                          if (sp.wallet_address?.isNotEmpty ?? false)
                            GestureDetector(
                              onTap: () async {
                                try {
                                  if (!await launchUrl(Uri.parse("https://translator.shyft.to/address/${sp.wallet_address}?cluster=devnet" ?? ""))) {
                                    throw Exception('Could not launch ${sp.wallet_address} this wallet');
                                  }
                                } catch (e) {
                                  // Handle any exception
                                  print('Error: $e');
                              ...
                              child: Image.asset("assets/images/solana.png", height: 27.h, width: 27.w),
                            ),
                        ],
                      ),
                      SizedBox(height: 20.h),
